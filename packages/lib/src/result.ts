...
export type Result<SuccessDataType, FailingDataType> = Ok<SuccessDataType, FailingDataType> | Err<SuccessDataType,FailingDataType>
...
export const ResultUtil = {
    ...
    all<Success, Failure>(results: Result<Success, Failure>[]): Result<Success[], Failure> {
        let oks: Success[] = []
    ...
    any<Success, Failure>(results: Result<Success, Failure>[]): Ok<Success[], Failure> {
        let oks: Success[] = []
